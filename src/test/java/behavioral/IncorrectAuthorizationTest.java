...
public class IncorrectAuthorizationTest {
...
//        driver = new ChromeDriver();
    ...
    public void test_authorization() throws Exception {
        ...
        serverMessage = driver.findElement(By.id("message"));
        assert serverMessage.getText().equals("User session: Incorrect user/password") : "Wrong message from server";
    }
}
